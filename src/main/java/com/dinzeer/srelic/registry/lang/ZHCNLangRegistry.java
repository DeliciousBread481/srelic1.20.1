...
public class ZHCNLangRegistry {
    public static void register() {
        ...
        REGISTRATE.addRawLang("tips.fel_metal.name_tip", "在下界手持下界合金碎片对准中心炼药锅激活");
        ...
        REGISTRATE.addRawLang("patchouli.srelic.book.entries.arrow.pledge_flame_vermilion_strand.pages.0.text", "击杀烈焰人时概率掉落或者用带有「火焰附加」附魔的剑挖取蜘蛛网获取");
        ...
        REGISTRATE.addRawLang("patchouli.srelic.book.entries.arrow.windy_core_ingot.pages.1.text", "天空合金，黯蓝如夜幕初垂。");
        REGISTRATE.addRawLang("patchouli.srelic.book.entries.arrow.windy_core_ingot.pages.2.text", "西风结晶与下界合金在雷暴中熔合，铸成可触碰的苍穹。$(br)轻若羽，坚若星，行走其上，脚下会落下一段被风剪碎的云。$(br)——若你在新月夜将一块天空合金掷向空中，它不会落地，而是悄悄替你把下一场风暴换成晴天。");
        ...
        REGISTRATE.addRawLang("patchouli.srelic.book.entries.arrow.blue_ingot.pages.0.text", "蓝色的蝴蝶融入下界合金之中，吸收星辰的力量，在量子的作用下形成两种合金。");
        REGISTRATE.addRawLang("patchouli.srelic.book.entries.arrow.rad_ingot.pages.0.text", "血色的蝴蝶融入下界合金之中，获得凋亡的力量，于量子中形成的两种合金。");
        REGISTRATE.addRawLang("patchouli.srelic.book.entries.arrow.phantom_trace_ingot.easter-egg", "§o持此锭者所见皆虚妄，所触皆蜃楼，唯痛楚真实不虚。");
        ...
        REGISTRATE.addRawLang("patchouli.srelic.book.entries.arrow.nightmare_core_ingot.easter-egg", "以护佑之心啜饮苦痛，此锭重铸之时亦是魇临之刻");
        ...
        REGISTRATE.addRawLang("tips.grammer_alloy.name_tip", "使用炽热下界合金锭击杀20只蠹虫获得");
        ...
        REGISTRATE.addRawLang("patchouli.srelic.book.entries.arrow.blood_plum.pages.0.text", "流离失所的商人带来的树苗，据说是某个女孩培育出来的特殊品种$(br2)($(o)与流浪商人交易获得)");
        ...
        REGISTRATE.addRawLang("patchouli.srelic.book.entries.arrow.red_tide_core.easter-egg", "人类用‘$(c)$(l)红$()’命名希望，而红潮用它命名了人类的墓志铭—— $(l) 一篇会流动的讣告。§r §c§o当毁灭成为常态，坚守人性是否是最浪漫的反叛？");
        ...
        REGISTRATE.addRawLang("se.srelic.path_of_erudition.desc", "根据武器附魔等级获得额外效果：锋利→伤害提升（每级+10%%） 火焰附加→点燃时间翻倍 抢夺→额外掉落概率");
        REGISTRATE.addRawLang("patchouli.se.srelic.path_of_erudition.desc", "根据武器附魔等级获得额外效果：$(br2)锋利→伤害提升（每级+10%%）$(br2)火焰附加→点燃时间翻倍$(br2)抢夺→额外掉落概率");
...
// 炽焰过载
        ...
        REGISTRATE.addRawLang("se.srelic.chaos_breaker.desc_8", "§d• 攻击附带120度扇形雷伤");
        ...
        REGISTRATE.addRawLang("se.srelic.dice_effect.desc_1", "• 20%概率造成50%伤害");
        REGISTRATE.addRawLang("se.srelic.dice_effect.desc_2", "• 40%概率正常伤害");
        REGISTRATE.addRawLang("se.srelic.dice_effect.desc_3", "• 39%概率治疗目标600%伤害值");
        REGISTRATE.addRawLang("se.srelic.dice_effect.desc_4", "• 1%概率造成1000%暴击伤害");
        REGISTRATE.addRawLang("patchouli.se.srelic.dice_effect.desc", "$(5)【随机法则】 $(br)• 20%%概率造成50%%伤害 $(br)• 40%%概率正常伤害 $(br)• 39%%概率治疗目标600%%伤害值$(br)• 1%%概率造成1000%%暴击伤害");
        ...
        REGISTRATE.addRawLang("se.srelic.crimson_annihilation", "§4始终之外");
        REGISTRATE.addRawLang("se.srelic.crimson_annihilation.desc", "每次普攻命中叠加一层「红椿·蕊」：  ");
        REGISTRATE.addRawLang("se.srelic.crimson_annihilation.desc_1", "每层提升1.5%普攻加深（上限100层）  ");
        REGISTRATE.addRawLang("se.srelic.crimson_annihilation.desc_2", "满层进入 「含苞状态」，普攻伤害倍率提升40%额外持续10秒");
...
// 特殊效果
        ...
        REGISTRATE.addRawLang(SRStacksReg.SHRIN_FISH_STACKS.getDescriptionKey(), "§b「河豚上岸哈气进度」");
        REGISTRATE.addRawLang(SRStacksReg.SANCTUARY_SHIELD.getDescriptionKey(), "§b「无瑕护盾」");
        REGISTRATE.addRawLang(SRStacksReg.PETAL_STACKS.getDescriptionKey(), "§l§4「红椿·蕊」");
        REGISTRATE.addRawLang(SRStacksReg.ResolveStacks.getDescriptionKey(), "§l§5「愿力」");
        ...
        REGISTRATE.addRawLang(CreateSeLang(SRSpecialEffectsRegistry.HunterStarBreakMoon), "【景星助狩月】");
        REGISTRATE.addRawLang(CreateSeLangDescs(SRSpecialEffectsRegistry.HunterStarBreakMoon), "击杀生物后增加【终结技】印记");
        REGISTRATE.addRawLang(CreateSeLangDescsCounts(SRSpecialEffectsRegistry.HunterStarBreakMoon, 1), "【终结技】印记满层后释放一次sa");
        REGISTRATE.addRawLang(SRStacksReg.PowerBoost.getDescriptionKey(), "§l「终结技」");
