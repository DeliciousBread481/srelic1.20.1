...
import com.dinzeer.srelic.compat.avaritia.SRSingularityProvider;
    ...
    public static void dataGen(GatherDataEvent event) {
        ...
        dataGenerator.addProvider(event.includeServer(), new SrelicBladeRecipeProvioder(packOutput));
          ...
          if (ModList.get().isLoaded("avaritia")){
              dataGenerator.addProvider(event.includeServer(), new SRSingularityProvider(dataGenerator, existingFileHelper));
          }
