...
import com.dinzeer.srelic.items.armor.*;
...
public class SRItemRegsitry {
    ...
    public static final ItemEntry<ExtremeArmor.Helmet> max_helmet=REGISTRATE.item(
            "max_helmet", properties -> new ExtremeArmor.Helmet()
             ).defaultModel().tag(Tags.Items.ARMORS, Tags.Items.ARMORS_HELMETS).defaultLang().tab(Srelic.SRItems.getKey()).register();
    ...
    ).defaultModel().tag(Tags.Items.ARMORS, Tags.Items.ARMORS_CHESTPLATES).defaultLang().tab(Srelic.SRItems.getKey()).register();
    public static final ItemEntry<ExtremeArmor.Leggings> max_leggings=REGISTRATE.item(
            ...
            ).defaultModel().tag(Tags.Items.ARMORS, Tags.Items.ARMORS_LEGGINGS).defaultLang().tab(Srelic.SRItems.getKey()).register();
    public static final ItemEntry<ExtremeArmor.Boots> max_boots=REGISTRATE.item(
            "max_boots", properties -> new ExtremeArmor.Boots()
            ).defaultModel().tag(Tags.Items.ARMORS, Tags.Items.ARMORS_BOOTS).defaultLang().tab(Srelic.SRItems.getKey()).register();
...
//    public static final ItemEntry<TheEndArmor.Helmet> the_end_helmet=REGISTRATE.item(
//            "the_end_helmet", properties -> new TheEndArmor.Helmet()
//    ).defaultModel().defaultLang().tab(Srelic.SRItems.getKey()).register();
//    public static final ItemEntry<TheEndArmor.Chestplate> the_end_chestplate=REGISTRATE.item(
//            "the_end_chestplate", properties -> new TheEndArmor.Chestplate()
//    ).defaultModel().defaultLang().tab(Srelic.SRItems.getKey()).register();
//    public static final ItemEntry<TheEndArmor.Leggings> the_end_leggings=REGISTRATE.item(
//            "the_end_leggings", properties -> new TheEndArmor.Leggings()
//    ).defaultModel().defaultLang().tab(Srelic.SRItems.getKey()).register();
//    public static final ItemEntry<TheEndArmor.Boots> the_end_boots=REGISTRATE.item(
//            "the_end_boots", properties -> new TheEndArmor.Boots()
//    ).defaultModel().defaultLang().tab(Srelic.SRItems.getKey()).register();
